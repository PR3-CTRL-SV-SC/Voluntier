<%@ Page Title="" Language="C#" MasterPageFile="~/PaginaMaestra/MPInicio.master" AutoEventWireup="true" CodeFile="PMenuAdministrador.aspx.cs" Inherits="PMenuEstudiante" %>
                                                ...
                                                <table cellpadding="0" cellspacing="0" style="border-width: 0;" runat="server">
                                                    <tr class="LBLContenido">
                                                        <td class="LBLContenido">
                                                            <a href="../Administrador/PGestionCampanias.aspx" class="Opcion">Campañas de Servicio Social                                              
